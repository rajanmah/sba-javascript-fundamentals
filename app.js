...
function getLearnerData(courseInfo, assignmentGroup, learnerSubmissions) {
  ...
  // tried to get valid data before due date of assignment submission
  ...
  // console.log(individualLearner(learnerSubmissions)) //{ '125': 3, '132': 2 } >>> Shows learner #125 has submitted 3 assignments and #132 has submitted 2 assignment 
